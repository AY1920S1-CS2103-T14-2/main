...
public class DisplayAttendanceCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Displays the tutorial attendance identified by the index number used in the displayed tutorial list.\n"
            + "Parameters: \n"
            + PREFIX_TUTORIAL_NAME + "TUTORIAL_NAME "
            + PREFIX_MODULE + "MODULE_CODE \n"
            + "Example: " + COMMAND_WORD + " " + PREFIX_TUTORIAL_NAME + "CS2040 " + PREFIX_MODULE + "MODULE_CODE \n";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        CommandResult commandResult = new CommandResult(String.format(MESSAGE_SUCCESS, tutorialToDisplay));
        commandResult.setAttendanceToDisplay(tutorialToDisplay);
