...
include::../UserGuide.adoc[tag=deletemodule]

include::../UserGuide.adoc[tag=deleteTutorial]

include::../UserGuide.adoc[tag=deleteStudent]
...
include::../UserGuide.adoc[tag=displayAssignmentScore]

include::../UserGuide.adoc[tag=displayAttendance]
